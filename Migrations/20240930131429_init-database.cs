    ...
    public partial class initdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvinceTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idLoaiTinh = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Addresses_ProvinceTypes_idLoaiTinh",
                        column: x => x.idLoaiTinh,
                        principalTable: "ProvinceTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_Addresses_idDiaChi",
                        column: x => x.idDiaChi,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Customers_idKhachHang",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_idLoaiTinh",
                table: "Addresses",
                column: "idLoaiTinh");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_idDiaChi",
                table: "Customers",
                column: "idDiaChi");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_idKhachHang",
                table: "Orders",
                column: "idKhachHang");
        }
