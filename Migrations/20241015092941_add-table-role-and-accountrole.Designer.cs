...
namespace WebPhongKham.Migrations
{
    ...
    [Migration("20241015092941_add-table-role-and-accountrole")]
    partial class addtableroleandaccountrole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebPhongKham.Models.AccountRole", b =>
                {
            ...
            modelBuilder.Entity("WebPhongKham.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebPhongKham.Models.AccountRole", b =>
                {
                    b.HasOne("WebPhongKham.Models.Account", "Account")
                        .WithMany("AccountRoles")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebPhongKham.Models.Role", "Role")
                        .WithMany("AccountRoles")
