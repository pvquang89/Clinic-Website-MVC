...
namespace WebPhongKham.Services
{
    public class VnPayService : IVnpayService
    {
        ...
        //_config để tự động map tới thành phần trong file appsettings tương ứng
        ...
        public string CreatePaymentUrl(HttpContext context, VnPaymentRequest model)
        {
            ...
            vnpay.AddRequestData("vnp_OrderInfo", "Thanh toán cho :" + model.OrderId);
            ...
            var paymentUrl = vnpay.CreateRequestUrl(_config["VnPay:BaseUrl"],
                                                _config["VnPay:HashSecret"]);                                                           //trùng lặp trong ngày
